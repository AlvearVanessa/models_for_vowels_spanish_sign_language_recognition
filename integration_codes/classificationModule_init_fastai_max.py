...
Based on: Teachable Machine and Computer Vision Zone
Websites:
...
class Classifier:
    ...
    def getPrediction(self, img, draw=True, pos=(50, 50), scale=2, color=(0, 255, 0)):
        ...
        return prediction[0], index, prediction[2], max_value  # ('A', tensor(0))



def main():
    cap = cv2.VideoCapture(0)
    maskClassifier = Classifier('C:/Users/master/PycharmProjects/vowels_lse_gesture_recognition/Model/export_resnet.pkl',
                                'C:/Users/master/PycharmProjects/vowels_lse_gesture_recognition/Model/labels.txt')
    while True:
        _, img = cap.read()
